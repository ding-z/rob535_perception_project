...
result_detector_name = 'detector_label_3_p9_e50_na6_v1';
...
featureExtractionNetwork = resnet18;%vgg16;%resnet101;%resnet50

featureLayer = 'res4b_relu';%'relu5_1';%'res4b20_relu';%'activation_40_relu'
